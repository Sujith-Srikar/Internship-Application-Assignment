  ...
  return (
    <div className="self-stretch flex-1 rounded-[35.56px] bg-brand-slate-green shadow-[8.9px_8.9px_12.62px_rgba(0,_0,_0,_0.25)] flex flex-col items-center justify-start pt-[35.6px] pb-[18.7px] pr-[24.5px] pl-6 box-border relative gap-[48px] min-w-[285.3333435058594px] min-h-[800px] text-left text-23xl-7 text-m3-sys-light-on-primary font-poppins mq450:gap-[24px_48px] mq725:pt-[23px] mq725:pb-5 mq725:box-border">
      ...
      <nav className="m-0 self-stretch flex flex-col items-center justify-start gap-[9.8px] text-center text-mid-8 text-m3-sys-light-on-primary font-poppins">
        <button className="cursor-pointer [border:none] pt-[20.8px] pb-[20.7px] pr-[124px] pl-[22.2px] bg-brand-slate-green-light self-stretch rounded-[17.78px] flex flex-row items-center justify-center gap-[15.1px] top-[0] z-[99] sticky hover:bg-steelblue mq450:pr-5 mq450:box-border">
          <img
        ...
        <NavLink
          ...
          className="w-full"
        >
          <button className=" bg-brand-slate-green cursor-pointer self-stretch rounded-[17.78px] flex flex-row items-center justify-start pt-[20.8px] pb-[20.7px] pr-[97px] pl-[22.2px] gap-[15.1px] hover:bg-steelblue mq450:pr-5 mq450:box-border">
            <img
              className="h-[20.7px] w-[21.6px] relative min-h-[21px]"
              loading="lazy"
              alt=""
      ...
      <img
        className="w-10 h-10 absolute !m-[0] top-[35.6px] left-[220.4px]"
        loading="lazy"
        alt=""
